    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (modChannelIds.includes(message.channel.id)) {
        if (
          ...
          return; // Return early so psy doesn't respond
        }
      }
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m psy. Need help?')
        .setThumbnail('https://raw.githubusercontent.com/sabattle/psyBot/develop/data/images/psy.png')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discordapp.com/oauth2/authorize?client_id=1146120556803010590&scope=bot&permissions=8)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [psy Support Server](https://discord.gg/Cf2trt46Y8)!
        `)
        .setFooter('DM abzinooooo to speak directly with the developer!')
